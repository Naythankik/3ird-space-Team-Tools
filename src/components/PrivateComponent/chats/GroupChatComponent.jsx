                ...
                <div className="flex-grow flex flex-col">
                    <div className="flex-grow flex-col-reverse flex p-6 overflow-y-auto">
                        <div className="space-y-4">
                            {messages.map((msg, id) =>
                                <div key={id} className="flex items-start space-x-4 p-4 hover:bg-gray-800/50 rounded-lg">
                                    <img src={msg.sender.avatar} alt={msg.sender.fullName} className="h-10 w-10 rounded-full object-cover flex-shrink-0 mt-1" />
                                    <div>
